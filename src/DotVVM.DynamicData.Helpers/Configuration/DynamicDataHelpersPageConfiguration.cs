...
public class DynamicDataHelpersPageConfiguration
{
    ...
    public DynamicDataHelpersPageConfiguration(string pageName, IReadOnlySet<Type> requiredSelectorTypes, string routeName, object routeParameters, Func<string> pageTitleProvider, string viewMarkup, IReadOnlyList<ToolbarButton> toolbarButtons, bool includeInMenu)
    {
        PageName = pageName;
